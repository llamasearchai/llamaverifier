"""
Client module for llamaverifier.
"""
...
class Client:
    """Main client for interacting with the llamaverifier API."""
    ...
    def __init__(self, api_key=None, base_url=None, config=None):
        ...
        self.base_url = base_url or "https://api.llamasearch.ai/llamaverifier"
    ...
    def process_data_async(
        self, data, options=None, on_progress=None, on_complete=None
    ):
        """
